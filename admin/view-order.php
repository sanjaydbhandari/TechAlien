            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header border-success">
                            ...
                            <a href="order-history.php" class="btn btn-danger float-end"><i class="fa fa-reply"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class=" mb-3">
                                        ...
                                        <select name="order_status" id="" class="form_status form-control">
                                ...
                                <button type="submit" name="updateOrderBtn" class="btn mt-6 p-2 fs-6 btn-sm btn-success">Update Order Status</button>
                                    </form>
                            </div>
                        </div>
                    </div>
